...
if(isset($_GET["action"]) && $_GET["action"]!=""){
    ...
    if($action == "active"){
        $sqlUpdate = "UPDATE `slider` SET `status` = '0' WHERE `id` ='$id'";
    } 
    if($action == "deactive"){
        $sqlUpdate = "UPDATE `slider` SET `status` = '1' WHERE `id` ='$id'";
    }
                ...
                <main>
                    <div class="container-fluid px-4 text-center text-capatilize text-bold">
                        ...
                        <div class="card mb-4">
                              ...
                              <a class="nav-link bg-primary col-2 btn-height text-center pt-2" href="manage-slider.php">
...
<div class="card-body">
                            ...
                            ?>
                                ...
                                ?>
                                            ...
                                            <td>
                                            <a href="manage-slider.php?id=<?php echo $row["id"]?>" class="btn btn-sm btn-primary"><span class="fas fa-pen"></span></a>
