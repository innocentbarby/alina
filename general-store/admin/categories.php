...
if(isset($_GET["action"]) && $_GET["action"]!=""){
    ...
    if($action == "active"){
        $sqlUpdate = "UPDATE `categories` SET `status` = '0' WHERE `id` ='$id'";
    } 
    if($action == "deactive"){
        $sqlUpdate = "UPDATE `categories` SET `status` = '1' WHERE `id` ='$id'";
    }
                ...
                <main>
                    <div class="container-fluid px-4 text-center text-capatilize text-bold">
                        ...
                        <div class="card mb-4">
                              ...
                              <a class="nav-link bg-primary col-2 btn-height text-center pt-2" href="manage-categories.php">
...
<div class="card-body">
                            ...
                            ?>
                                    ...
                                    <td>
                                    <a href="assets/img/categories/<?php
                                if(empty($row["image"])){
                                    echo "dummy img.png";
                                }else{
                                    echo $row["image"];
                                ...
                                ?>" target="_blank">
                                <img src="assets/img/categories/<?php
                                if(empty($row["image"])){
                                    echo "dummy img.png";
                                }else{
                                    echo $row["image"];
                                ...
                                ?>
                                            ...
                                            <td>
                                            <a href="manage-categories.php?id=<?php echo $row["id"]?>" class="btn btn-sm btn-primary"><span class="fas fa-pen"></span></a>
