                ...
                <main>
                    <div class="container-fluid px-4 text-center text-capatilize text-bold">
                        ...
                        <div class="card mb-4">
                              ...
                              <a class="nav-link bg-primary col-2 btn-height text-center pt-2" href="manage-reviews.php">
                              <i class="fas fa-plus"></i>add Reviews</a>
<div class="card-body">
                            ...
                            ?>
                                ...
                                ?>
                                            ...
                                            <td>
                                            <a href="manage-reviews.php?id=<?php echo $row["id"]?>" class="btn btn-sm btn-primary"><span class="fas fa-pen"></span></a>
